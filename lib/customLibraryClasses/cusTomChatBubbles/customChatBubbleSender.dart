...
class ChatBubbleSender extends CustomClipper<Path> {
  final BubbleType type;
  final double radius;
  final double nipSize;

  ChatBubbleSender({this.type, this.radius = 15, this.nipSize = 7});
  ...
  Path getClip(Size size) {
    ...
    if (type == BubbleType.sendBubble) {
      ...
      path.arcToPoint(Offset(1 * nipSize, size.height - nipSize),
          radius: Radius.circular(1 * nipSize));
