...
class CustomDialogSwitch extends StatelessWidget {
  final bool switched;

  CustomDialogSwitch({this.switched});

  @override
  Widget build(BuildContext context) {
    var tween = MultiTween<_SwitchBoxProps>()
      ..add(_SwitchBoxProps.paddingLeft, 0.0.tweenTo(60.0), 1.seconds)
      ..add(_SwitchBoxProps.color, Colors.red.tweenTo(Colors.lime), 1.seconds)
      ..add(_SwitchBoxProps.text, ConstantTween("NO"), 500.milliseconds)
      ..add(_SwitchBoxProps.text, ConstantTween("YES"), 500.milliseconds)
