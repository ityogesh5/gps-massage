...
UserReviewandRatingsViewResponseModel userReviewandRatingsViewResponseModelFromJson(String str) => UserReviewandRatingsViewResponseModel.fromJson(json.decode(str));

String userReviewandRatingsViewResponseModelToJson(UserReviewandRatingsViewResponseModel data) => json.encode(data.toJson());
...
class UserReviewandRatingsViewResponseModel {
    ...
    factory UserReviewandRatingsViewResponseModel.fromJson(Map<String, dynamic> json) => UserReviewandRatingsViewResponseModel(
        status: json["status"],
