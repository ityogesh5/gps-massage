...
void main() => runApp(MyBubbleApp());

class MyBubbleApp extends StatefulWidget {
  @override
  _ChatListUserScreenState createState() => _ChatListUserScreenState();
}

class _ChatListUserScreenState extends State<MyBubbleApp> {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('Chat Bubble List'),
        ),
        body: MainScreen(),
      ),
    );
