...
class GivenRatingReviewScreen extends StatefulWidget {
  @override
  _GivenRatingReviewScreenState createState() =>
      _GivenRatingReviewScreenState();
}

class _GivenRatingReviewScreenState extends State<GivenRatingReviewScreen> {
  ...
  getUserReviewList() {
    ServiceProviderApi.getBookingOrderReviewDetail(
