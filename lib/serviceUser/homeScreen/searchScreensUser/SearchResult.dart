...
class _SearchResultState extends State<SearchResult> {
          ...
          for (int i = 0; i < getTherapistsSearchResults.length; i++) {
            ...
            k++) {
              if (getTherapistsSearchResults[i].user.addresses != null) {
                ...
                print(
                    'Position values : ${addressOfTherapists[0]} && ${therapistAddress
                        .length}');

                print(
                    'State List values : ${stateOfTherapist[0]} && ${stateOfTherapist
                        .length}');

                print(
                    'City List values : ${cityOfTherapist[0]} && ${cityOfTherapist
                        .length}');
  ...
  void showToolTipForResults(String text,
      GlobalObjectKey<FormState> formKeyList) {
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            cityOfTherapist != null &&
                                              ...
                                              child: Container(
                                                child: Text(
                                                  '${cityOfTherapist[index] +
                                                      ',' +
                                                      '${stateOfTherapist[index]}'}',
                                                  style: TextStyle(
                                                      fontSize:
                                                      14,
                                                      fontWeight:
          ...
          setState(() {
            if (selected) {
              ...
              if (selected && i == 0) {
                ...
                print(
                    'Chip value else loop : ${_options[_selectedIndex]
                        .toString()}');
              }
            }
          });
