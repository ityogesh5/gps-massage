...
class ColorLoaderExample extends StatefulWidget {
  final double radius;
  final double dotRadius;

  ColorLoaderExample({this.radius = 30.0, this.dotRadius = 3.0});

  @override
  _ColorLoader3State createState() => _ColorLoader3State();
}

class _ColorLoader3State extends State<ColorLoaderExample>
